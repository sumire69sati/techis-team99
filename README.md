...
| 3 | 商品登録削除機能 | 商品の登録更新削除を行う | 商品名やカテゴリ選択、詳細情報の記入欄と登録ボタンや選択した商品を削除するためのゴミ箱ボタンを表示する | 新規登録商品の商品名やカテゴリ選択詳細情報を記入し登録する。商品を選択し、削除する。 |
| 3 | ユーザー一覧機能 | ユーザー情報を把握・管理出来る | ID番号・名前・メールアドレス・権限の有無・更新日・編集ボタンを表示する | 管理者のみがユーザー一覧を確認出来る |                 
| 3 | ユーザー情報更新削除機能 | ユーザー情報の更新や削除を行う| 編集ページにユーザーIdを表示し、氏名・メールアドレス記入欄を表示させる。更新・削除ボタンを表示させる | 管理者ユーザーのみ、ユーザー情報の更新や削除が出来る |  
